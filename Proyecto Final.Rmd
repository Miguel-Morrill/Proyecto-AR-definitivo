...
Una prueba rápida de curtosis nos permite conocer si también la distribución es normal. Recordando, en una distribución normal la Curtosis debe ser **3**.
```{r}
...
```
Para el 2016, los rendimientos son casi **Normales**, con un una Ho aceptada y Curtosis ligeramente mayor a la Normal.
...
```
Para el 2017, los rendimientos son casi **Normales**, con un una Ho aceptada y Curtosis ligeramente mayor a la Normal.
...
.name_repair = ~ c("Diez días","Veinte días","Treinta días"))
...
Usar los parámetros mu, sigma(anuales) de la distribución del periodo 2020 y construir la ecuación
lnsT = ln s0" que representa una estimación del comportamiento del precio. Usar esta ecuación
para construir una simulación usando valores aleatorios y proporcionar una estimación del precio
dentro de 3, 6, 9 y 12 meses. Incluir un intervalo de confianza al 95% para las estimaciones.
