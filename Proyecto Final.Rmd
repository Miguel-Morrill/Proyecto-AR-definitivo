...
Correlación: en que grado un activo afecta a otro
...
## Gráficas Individuales de rendimientos de los 6 activos + IPC
...
## Gráfica con todos los rendimientos de los 6 activos + IPC
...
Debido a que nos elimina los missing values la grafica de rendimientos del IPC sale de forma incompleta
...
Resultados2 <- merge.xts(Var_Est_EWMA, Var_Real)
names(Resultados2) <- c('Var_EWMA','Var_Real')
